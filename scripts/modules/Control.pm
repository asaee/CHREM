...
our @EXPORT = qw(basic_5_season slave free_float CFC_control SDHW_control ICE_CHP_control SE_CHP_control SCS_control AWHP_control SAHP_S_control SAHP_P_control BIPHVT_control ICE_CHP_control_bldg BIPHVT_control_bldg);
	...
	if ($sys_type =~ /1/) {
		@control = 
			  ('* Control loops    1',
			   ...
			   '   12    8   0.000  # ctl type, law (On-Off control.), start @',
			   '      7.  # No. of data items',
			   '  1.00000 45.00000 50.00000 1.00000 0.00000 0.00000 0.00000',
			   '* Control loops    2',   
...
sub SAHP_S_control {
	...
	my $pump_HWtank_signal; 	# A signal that indicates pump flow rate
	my $pump_radiator_signal; 	# A signal that indicates pump flow rate
	my $fan_signal;		 	# A signal that indicates fan flow rate
	my $HP_signal_1;		 	# A signal that indicates heat pump heating rate
	my $HP_signal_2;		 	# A signal that indicates heat pump heating rate
	my $HP_signal_3;		 	# A signal that indicates heat pump heating rate
	my $ON_T;
	my $OFF_T;
	my $aux_node; # 1 for condensing and 2 for non-condensing
	...
	$dsgn_htng_load = sprintf ("%.0f", 1000.0 * $dsgn_htng_load);
	$pump_tank_signal = sprintf ("%.5f", $no_coll_loop * 3 * 0.00002);
	$pump_HWtank_signal = sprintf ("%.5f", $dsgn_htng_load /4200.0/ 20.0/ 1000.0);
	$fan_signal = sprintf ("%.5f", $dsgn_htng_load /1000.0/ 30.0);
	$HP_signal_1 = sprintf ("%.1f", $dsgn_htng_load /4.20/ 10.0);
	$HP_signal_2 = 0.87 * $HP_signal_1 ;
	$HP_signal_3 = 0.625 *$HP_signal_1 ;
	...
	if ($sys_type =~ /1/) {
		@control = 
			  ('* Control loops    1',
			   ...
			   "  1.00000 50.00000 55.00000 $pump_HWtank_signal 0.00000 0.00000 0.00000",
			   '* Control loops    3',
			   '# sen var diff bet compt.  3:storage_tank @ node  2',
			   '   -1   3    2    0    0  # sensor ',
			   '# plant component  22:fan @ node no.  1',
			   '   -1    22    1    0  # actuator ',
			   '    1  # all daytypes',
			   '    1  365  # valid Sat-01-Jan - Sun-31-Dec',
			   '     1  # No. of periods in day: weekday     ',
			   '    12    8   0.000  # ctl type, law (On-Off control.), start @',
			   '      7.  # No. of data items',
			   "  -1.00000 2.00000 1.00000 $fan_signal 0.00000 0.00000 0.00000",
			   '* Control loops    4',
			   '# senses var in compt.  11:HW_tank @ node no.  2',
			   '   -1    11    2    0    0  # sensor ',
			   '# plant component   15:HP @ node no.  1',
			   '   -1    15    1    0  # actuator ',
			   '    6  # all daytypes',
			   '    1   31  # valid Sat-01-Jan - Mon-31-Jan',
			   '     1  # No. of periods in day: weekday     ',
			   '   12    8   0.000  # ctl type, law (On-Off control.), start @',
			   '      7.  # No. of data items',
			   "  1.00000 50.00000 55.00000 $HP_signal_1 0.00000 0.00000 0.00000",
			   '    32   59  # valid Sat-01-Jan - Mon-31-Jan',
			   '     1  # No. of periods in day: weekday     ',
			   '   12    8   0.000  # ctl type, law (On-Off control.), start @',
			   '      7.  # No. of data items',
			   "  1.00000 50.00000 55.00000 $HP_signal_1 0.00000 0.00000 0.00000",
			   '    59   151  # valid Sat-01-Jan - Mon-31-Jan',
			   '     1  # No. of periods in day: weekday     ',
			   '   12    8   0.000  # ctl type, law (On-Off control.), start @',
			   '      7.  # No. of data items',
			   "  1.00000 50.00000 55.00000 $HP_signal_2 0.00000 0.00000 0.00000",
			   '   152   273  # valid Sat-01-Jan - Mon-31-Jan',
			   '     1  # No. of periods in day: weekday     ',
			   '   12    8   0.000  # ctl type, law (On-Off control.), start @',
			   '      7.  # No. of data items',
			   '  1.00000 50.00000 55.00000 0.000100 0.00000 0.00000 0.00000',
			   '   274   300  # valid Sat-01-Jan - Mon-31-Jan',
			   '     1  # No. of periods in day: weekday     ',
			   '   12    8   0.000  # ctl type, law (On-Off control.), start @',
			   '      7.  # No. of data items',
			   "  1.00000 50.00000 55.00000 $HP_signal_3 0.00000 0.00000 0.00000",
			   '   301   365  # valid Sat-01-Jan - Mon-31-Jan',
			   '     1  # No. of periods in day: weekday     ',
			   '   12    8   0.000  # ctl type, law (On-Off control.), start @',
			   '      7.  # No. of data items',
			   "  1.00000 50.00000 55.00000 $HP_signal_2 0.00000 0.00000 0.00000",
			   '* Control loops    5',
			   '# senses var in compt. 3:storage-tank @ node no.  2',
			   '   -1   3    2    0    0  # sensor ',
			   '# plant component  21:pump-HP @ node no.  1',
			   '   -1   21    1    0  # actuator ',
			   '    1  # all daytypes',
			   '    1  365  # valid Sat-01-Jan - Sun-31-Dec',
			   '     1  # No. of periods in day: weekday     ',
			   '    12    8   0.000  # ctl type, law (On-Off control.), start @',
			   '      7.  # No. of data items',
			   "  -1.00000 2.00000 1.00000 $pump_HWtank_signal 0.00000 0.00000 0.00000",
			   '* Control loops    6',
			   '# senses var in compt.  7:aux-boiler @ node no.  2',
			   '   -1    7    2    0    0  # sensor ',
			   '# plant component   7:aux-boiler @ node no.  2',
			   ...
			   '# sen var diff bet compt.  3:storage_tank @ node  2and compt 11:HW_tank @ node  1',
			   '   -1    3    2   11    1  # sensor ',
			   '# plant component  20:valve-HX @ node no.  1',
			   '   -1   20    1    0  # actuator ',
			   '    1  # all daytypes',
			   '    1  365  # valid Sat-01-Jan - Sun-31-Dec',
			   '     1  # No. of periods in day: weekday',
			   ...
			   '# sen var diff bet compt.  3:storage_tank @ node  2and compt 11:HW_tank @ node  1',
			   '   -1    3    2   11    1  # sensor',
			   '# plant component  19:valve-HP @ node no.  1',
			   '   -1   19    1    0  # actuator',
			   '    1  # all daytypes',
			   '    1  365  # valid Sat-01-Jan - Sun-31-Dec',
			   '     1  # No. of periods in day: weekday',
...
sub BIPHVT_control {
	my $sys_type = shift; # BIPHVT system type
	my $set_point_T = shift; # Heating ste point temperature for main 1 (from CSDDRD database)
	my $dsgn_htng_load = shift; # capacity of existing heating system
	my $mult = shift; # dhw multiplier
	...
	#mass flow rate= design heating load / delta T /specific heat of water/ 1000 
	$pump_radiator_signal = sprintf ("%.6f",$dsgn_htng_load / 20.0 /4200.0/1000.0);		
	my $pump_HWtank_signal = sprintf ("%.5f", $dsgn_htng_load /4200.0/ 30.0/ 1000.0);
	my $fan_signal = sprintf ("%.5f", $dsgn_htng_load /1000.0/ 30.0);
	my $HP_signal = -0.25 * $dsgn_htng_load;
	my $HP_signal_low = 0.1 * $HP_signal;

	my @control;
	if ($sys_type =~ /1/) {
		@control = 
			  ('* Control loops    1',
			   '# senses var in compt.  5:pump_radiator @ node no.  1',
			   '   -1    5    1    0    0  # sensor ',
			   '# plant component   1:WAHP @ node no.  1',
			   '   -1    1    1    0  # actuator ',
  			   '    3  # all daytypes',
  			   '    1  99  # valid Wed-01-Jan - Wed-31-Dec',
  			   '     1  # No. of periods in day: weekday',     
  			   '   12    8   0.000  # ctl type, law (On-Off control.), start @',
  			   '      7.  # No. of data items',
  			   "  1.00000 50.00000 55.00000 $HP_signal 0.00000 0.00000 0.00000",
  			   '    100  319  # valid Wed-01-Jan - Wed-31-Dec',
  			   '     1  # No. of periods in day: weekday',     
  			   '   12    8   0.000  # ctl type, law (On-Off control.), start @',
  			   '      7.  # No. of data items',
  			   "  1.00000 50.00000 55.00000 $HP_signal_low 0.00000 0.00000 0.00000",
  			   '  320  365  # valid Wed-01-Jan - Wed-31-Dec',
  			   '     1  # No. of periods in day: weekday',     
  			   '   12    8   0.000  # ctl type, law (On-Off control.), start @',
  			   '      7.  # No. of data items',
  			   "  1.00000 50.00000 55.00000 $HP_signal 0.00000 0.00000 0.00000",
			   ...
			   '# senses var in compt.  2:HW_tank @ node no.  2',
			   '   -1    2    2    0    0  # sensor ',
			   '# plant component   7:fan @ node no.  1',
			   '   -1    7    1    0  # actuator ',
  			   '    1  # all daytypes',
			   '    1  365  # valid Wed-01-Jan - Wed-31-Dec',
			   '     1  # No. of periods in day: weekday     ',
			   '   12    8   0.000  # ctl type, law (On-Off control.), start @',
			   '      7.  # No. of data items',
			   "  1.00000 50.00000 55.00000 $fan_signal 0.00000 0.00000 0.00000",
			   '* Control loops    4',   
			   '# senses var in compt.  3:aux-boiler @ node no.  2',
			   '   -1    3    2    0    0  # sensor ',
			   '# plant component   3:aux-boiler @ node no.  1',
			   ...
			   "  1.00000 1.00000 $mult",
			   '* Control loops    7',
			   '# senses var in compt. 12:DHW-tank @ node no.  1',
			   '   -1   12    1    0    0  # sensor ',
			   '# plant component  11:DHW-pump @ node no.  1',
			   '   -1   11    1    0  # actuator ',
			   '    1  # all daytypes',
			   '    1  365  # valid Sat-01-Jan - Sun-31-Dec',
			   '     1  # No. of periods in day: weekday     ',
...
sub BIPHVT_control_bldg {
	my $sys_type = shift; # ICE_CHP system type
	my $zone_num = shift; # Zone number to be connected to the plant component
	my $num_of_controls = shift; # Zone name to be connected to the plant component
	my $comp_num = shift; # component number to be connected to the specified zone
	...
	if ($sys_type =~ /1|2/) {
		@control = 
			  ("* Control function    $num_of_controls",
			   "# senses dry bulb temperature in zone number $zone_num.",
			   "   $zone_num    0    0    0  # sensor data",
			   "# actuates the air point in zone number $zone_num.",
			   "   $zone_num    0    0  # actuator data",
			   ...
			   '   0    6   0.000  # ctl type, law (flux zone/plant), start @',
			   '   7.  # No. of data items',
			   "   1 2.000 2.000 0.000 99000.000 $comp_num 1.000");
	}
